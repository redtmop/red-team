                ...
                PipeTransmissionMode.Message))
                {
                    ...
                    while (true)
                    {
                        ...
                        try
                        {
                            ...
                            Console.WriteLine("[*] Sending response with length {0}...", response.Length);
                            //this is just to workaround the blocking pipe read ...
                            if (response.Length == 0)
                            {
                                response = Encoding.ASCII.GetBytes("Thisisdummy");
                            }
